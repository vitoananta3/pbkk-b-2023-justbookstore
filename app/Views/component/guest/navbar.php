<nav class="bg-[#434C5E] fixed w-full z-20 top-0 start-0">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4">
    ...
    <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
      ...
      <div class="z-50 hidden my-4 text-base list-none bg-[#434C5E] divide-y divide-gray-100 rounded-lg shadow dark:divide-gray-600" id="user-dropdown">
        <ul class="py-2" aria-labelledby="user-menu-button">
          <?php if (session()->has('user')) : ?>
            <li>
              <a href="<?= base_url() ?>signout<?php if (session()->getFlashdata('message')) : ?>
    ...
    <?php endif; ?>" class="block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 text-[#E5E9F0] dark:hover:text-white">Sign Out</a>
            </li>
          <?php else : ?>
            <li>
