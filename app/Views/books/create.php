    ...
    <div class="flex items-center w-6/12 max-w-screen-xl mb-8">
        <div class="flex flex-col w-full">
            ...
            <div class="text-sm flex flex-col justify-center gap-2">
                ...
                <div class="my-2"></div>
                <label class="block text-[#434C5E] dark:[#434C5E]" for="cover">Cover</label>
                <input name="cover" class="block w-full text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-[#434C5E] focus:outline-none dark:bg-[#E5E9F0] dark:border-<?= $validation->hasError('cover') ? 'red-600' : '[#434C5E]' ?> dark:placeholder-<?= $validation->hasError('cover') ? 'red-600' : '[#434C5E]' ?>" id="cover" type="file">
                <p class="mt-1 text-<?= $validation->hasError('cover') ? 'red-600' : '[#434C5E]' ?> font-thin">.jpg, .jpeg or .png | max size 1MB | max dimension 510px X 784px.</p>
