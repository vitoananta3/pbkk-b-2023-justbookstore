...
<div class="flex flex-col items-center max-h-screen bg-[#E5E9F0]">
    ...
    <div class="flex spa-2 w-full max-w-screen-xl">
        ...
        <div class="flex flex-col w-1/2 justify-between h-full pl-4">
            ...
            <div class="flex flex-col justify-center flex-grow self-center gap-10">
                <a href="#" class="flex items-center gap-2 text-sm bg-[#434C5E] hover:bg-[#81A1C1] text-[#E5E9F0] hover:text-[#434C5E] rounded-md px-3 py-2.5 transition-colors duration-200">
                ...
                <a href="#" class="flex items-center gap-2 text-sm bg-[#434C5E] hover:bg-[#81A1C1] text-[#E5E9F0] hover:text-[#434C5E] rounded-md px-3 py-2.5 transition-colors duration-200 opacity-70    ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
